...
$result = mysqli_query($conn, "SELECT * FROM events e,staff_coordinator s ,event_info ef ,student_coordinator st where e.event_id= ef.event_id and e.event_id= s.event_id and e.event_id= st.event_id and e.event_id not in (select event_id from registered where usn='$usn')");
?>
<div class="content">
    <div class="container">
